...
/*
        //training_bath(colordata,actualres,0.01);
        //training_adapted();
        ...
        System.out.println("wrong times____"+wrongtime+"/"+10000); /* */
    }
    ...
    public static void training_adapted() throws Exception {
        ...
        for (int epoch=0;epoch<500 ;epoch++ ) {
            ...
            System.out.println(variable_json(loss));
            ...
            System.out.println(variable_json(num_class));
            ...
            for(int b=0;b<100;b++){
                ...
                times[imageclass]++;
                System.out.println(variable_json(layer_out));
    ...
    public static void LeNet_5_network(String RBFparameterdir,String imagepath,String labelpath) throws Exception {
        ...
        RBF = new int[10][];
        for (int n = 0; n < 10; n++) {  // note relative path
            int[][][] bmpcolor = path_colorarr(RBFparameterdir + "\\" + n + ".bmp");
            int index = 0;
        ...
        for (int i = 0, il = weightsum.length; i < il; i++) {
            weight_initialize(weightsum[i], 2.4);
            weight_initialize(biassum, 1.2);
...
/*        speicificbias=((node[])parameter[2][2])[0];
    ...
    public static void read() throws Exception {
        ...
        br.close();
        Object json=new JSONArray(sb.toString());
        read(json,parameter);
    }
    ...
    public static String modelpath="LeNet-5_Neuron.txt";
    public static void save() throws Exception {
        json_txtpath(save(parameter),modelpath); //默认存储parameter
    }
    ...
    public static StringBuilder json_sb(Object json) throws Exception {
        StringBuilder sb=new StringBuilder();
        switch (json.getClass().getTypeName()){
            case "org.json.JSONObject":{
            ...
            break;
            default:{
                throw new Exception("type not completed !");
            }
        }
        return sb;
    }
